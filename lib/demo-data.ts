...
export const projects: Project[] = [
  {
    ...
    status: "심사 진행중",
    files: [
      { id: "file-001", fileName: "사업계획서.pdf", fileType: "PDF", analysisStatus: "완료" },
      { id: "file-002", fileName: "입면_색채계획.pptx", fileType: "PPTX", analysisStatus: "완료" },
      { id: "file-003", fileName: "배치도_도면.zip", fileType: "ZIP", analysisStatus: "완료" },
    ],
  },
  {
    id: "project-002",
  ...
  },
  {
    ...
    status: "심사 진행중",
    files: [
      { id: "file-004", fileName: "경관개선계획서.pdf", fileType: "PDF", analysisStatus: "완료" },
    ],
  },
  {
    id: "project-005",
  ...
  },
  {
    ...
    status: "심사 진행중",
    files: [
      { id: "file-006", fileName: "야간경관_조명계획.pdf", fileType: "PDF", analysisStatus: "완료" },
      { id: "file-007", fileName: "조감도.png", fileType: "PNG", analysisStatus: "완료" },
    ],
  },
  {
    id: "project-007",
  ...
  },
  {
    ...
    status: "접수",
    files: [
      { id: "file-008", fileName: "환승센터_배치도.dwg", fileType: "DWG", analysisStatus: "대기" },
    ],
  },
];
