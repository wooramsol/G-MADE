...
export default function IntegrationStatusPanel({ group, checkedAt }: IntegrationStatusPanelProps) {
  ...
  return (
    <div className="flex min-h-[148px] flex-col rounded-md border border-[#d7dee8] bg-white p-5 panel-shadow">
...
function IntegrationStatusRow({ row }: { row: IntegrationRow }) {
  return (
    <div className="rounded-md border border-[#d7dee8] bg-[#f8fafc] px-3 py-2.5">
